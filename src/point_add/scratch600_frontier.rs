...
fn scratch600_frontier_requires_selector_or_parser_breakthrough() {
    ...
    assert!(
        ...
        "full block-pattern code local decoder no longer has the recorded nonlocal-context blocker"
    );
    assert!(
