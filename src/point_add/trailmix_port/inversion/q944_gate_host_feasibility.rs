...
use super::q945_local_hosts::{
    q945_carry_route, Q945CarryRoute, Q945Host, Q945StateRegister, Q945Substep, Q945_NON_HCLZ_ROWS,
};
...
fn register_limbs(boundary: Q945HostBoundaryState, register: Q945StateRegister) -> [u64; 8] {
    match register {
...
fn paired_host(substep: Q945Substep, host: Q945Host) -> Option<Q945Host> {
...
fn host_action_blocker(row: usize, substep: Q945Substep, host: Q945Host) -> Option<&'static str> {
    use Q945StateRegister::{Ca, Cb, A};
    match (row, substep, host.register, host.bit) {
        ...
        (379, Q945Substep::Multiply, A, 71) => Some("row379-a71-is-a-body-transcript-lender"),
    ...
    pub fn record_factor(
        ...
        for &observation in observations {
            ...
            let class = self
                .classes
                .get_mut(&key)
                .expect("unclassified Q944 gate call");
            ...
            class.alt_cancel_observations += usize::from(phase == Q945SupportPhase::AltCancel);
    ...
    pub fn finish(self) -> Q944GateHostFeasibilityReport {
        ...
        for ((row, substep), class) in self.classes {
            ...
            let blocker = if class.gate_predicate_checks != class.observations {
                ...
                match (row, substep) {
                    (364, Q945Substep::Division) => {
                        Some("row364-b80-is-division-body-target-and-no-paired-outer-zero-host")
                    }
                    (374, Q945Substep::Division) => {
                        Some("row374-q24-is-division-body-target-and-no-paired-outer-zero-host")
                    }
