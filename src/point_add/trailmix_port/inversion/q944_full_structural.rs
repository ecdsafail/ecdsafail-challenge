...
pub const Q944_GATE_HOST_CENSUS_COMMIT: &str = "9ee33567e2a4e20176300ede56ad01b3bf86fcab";
pub const Q944_GATE_HOST_CENSUS_TREE: &str = "46a78e5c5141fe3b1f169c739b699b18946c6015";
pub const Q944_GATE_HOST_CENSUS_JOB: usize = 71_935;
pub const Q944_QUOTIENT_WITNESS_COMMIT: &str = "1817f74f2fae27d622b46151fef45cf68acc0902";
pub const Q944_QUOTIENT_WITNESS_TREE: &str = "f5aad72a891e404006a929d853bdc45441aca866";
pub const Q944_QUOTIENT_WITNESS_JOB: usize = 71_968;
pub const Q944_QUOTIENT_WITNESS_BLOB: &str = "be5c4e15916eea2121fc120809dead8e0fbfd0a3";
...
pub fn q944_full_gate_route(row: usize, substep: Q945Substep) -> Q944FullGateRoute {
    use Q945StateRegister::{Ca, Cb, A, B};
