...
const STREAM_X_PER_TRAVERSAL: usize = 43_779_376;
const STREAM_CX_PER_TRAVERSAL: usize = 34_619_228;
// Includes the two emitted CCX gates for every clean-C3X MBU marker.
const STREAM_CCX_PER_TRAVERSAL: usize = 84_959_525;
const STREAM_HMR_PER_TRAVERSAL: usize = 9_696;
const STREAM_CZ_PER_TRAVERSAL: usize = 9_696;
