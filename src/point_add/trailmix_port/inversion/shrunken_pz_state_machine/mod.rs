...
fn p_plus_1_bytes() -> Vec<u8> {
    ...
    let pp1 = BigUint::from_bytes_le(&crate::point_add::trailmix_port::arith::mod_arith::SECP256K1_P_LE) + BigUint::from(1u32);
...
/// `parity`, and `counter` (10 bits) are fixed-width.
#[allow(clippy::too_many_arguments)]
