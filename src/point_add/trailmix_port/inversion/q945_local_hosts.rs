...
pub enum Q945CarryRoute {
    Borrow(Q945Host),
    Row364DivisionLower80 { carry: Q945Host, not_gate: Q945Host },
}
...
pub fn q945_hclz_route(row: usize, substep: Q945Substep, form: Q945HclzForm) -> Q945HclzRoute {
    assert!(
    ...
    match host {
        ...
        None if Q945_DIRECT_HCLZ_CLASSES.contains(&(row, substep, form)) => Q945HclzRoute::Direct,
        None => panic!(
...
pub fn q945_carry_route(row: usize, substep: Q945Substep) -> Q945CarryRoute {
    ...
    use Q945StateRegister::{Ca, Cb, A, B, Q};
    match (row, substep) {
