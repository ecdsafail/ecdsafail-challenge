...
fn clz_diff_body_middle(
    ...
    bit_length_lean_middle(circ, &aw, &pa, false, |_| false); // pa = pos_a
    xor_const(circ, &pb, nb);
    bit_length_lean_middle(circ, &bw, &pb, false, |_| false); // pb = pos_b
    ...
    bit_length_lean_middle(circ, &bw, &pb, false, |_| false); // pb -> nb
    xor_const(circ, &pb, nb); // pb -> 0
    bit_length_lean_middle(circ, &aw, &pa, false, |_| false); // pa -> na
