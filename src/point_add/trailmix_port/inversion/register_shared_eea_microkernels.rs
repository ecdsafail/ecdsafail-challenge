...
/// Subtract one when all controls are set. Lower bits are updated first.
...
pub fn pre_shift(
    ...
    controlled_decrement_mod_2n(circ, both, shift_length, carries);
    controlled_decrement_mod_2n(circ, both, shift_length, carries);
    circ.ccx(phase1_is_zero, phase2, both);
    toggle_phase1_is_zero(circ, phase1, phase1_is_zero);
}
...
pub fn pre_shift_inverse(
    ...
    circ.ccx(phase1_is_zero, phase2, both);
    controlled_decrement_mod_2n(circ, phase1_is_zero, shift_length, carries);
...
pub fn post_shift_inverse(
    ...
    controlled_rotate_high_two_inverse(circ, both, work2);
    circ.ccx(phase1, phase2, both);
    controlled_decrement_mod_2n(circ, phase1, shift_length, carries);
...
fn build_length_primitive(width: usize, primitive: LengthPrimitive) -> B {
    ...
    let mut circ = Circuit::new();
    match primitive {
        LengthPrimitive::Increment | LengthPrimitive::Decrement => {
        ...
        LengthPrimitive::ControlledIncrement | LengthPrimitive::ControlledDecrement => {
