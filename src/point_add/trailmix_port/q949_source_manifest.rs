// Every packaged source that can change allocation, operation serialization,
// Fiat-Shamir sampling, or embedded support data belongs here. Auxiliary proof
// binaries, tools, and WMI scripts are deliberately excluded because the
// challenge packages only src/point_add.
pub(super) const SOURCES: &[(&str, &[u8])] = &[
    ...
    (
        "src/point_add/trailmix_port/inversion/register_shared_eea.rs",
        include_bytes!("inversion/register_shared_eea.rs"),
    ),
    (
        "src/point_add/trailmix_port/inversion/register_shared_eea_microkernels.rs",
        include_bytes!("inversion/register_shared_eea_microkernels.rs"),
    ),
    (
        "src/point_add/trailmix_port/inversion/register_shared_eea_reference.rs",
        include_bytes!("inversion/register_shared_eea_reference.rs"),
    ),
    (
        "src/point_add/trailmix_port/inversion/q944_dirty_catalytic_predicate.rs",
        include_bytes!("inversion/q944_dirty_catalytic_predicate.rs"),
    ),
    (
    ...
    (
        "src/point_add/trailmix_port/inversion/q944_full_structural.rs",
        include_bytes!("inversion/q944_full_structural.rs"),
    ),
    (
        "src/point_add/trailmix_port/inversion/q944_gate_host_feasibility.rs",
        include_bytes!("inversion/q944_gate_host_feasibility.rs"),
    ),
    (
        "src/point_add/trailmix_port/inversion/q944_gate_host_lifecycle.rs",
        include_bytes!("inversion/q944_gate_host_lifecycle.rs"),
    ),
    (
        "src/point_add/trailmix_port/inversion/q944_quotient_witness.rs",
        include_bytes!("inversion/q944_quotient_witness.rs"),
    ),
    (
