    ...
    crate::point_add::trailmix_port::arith::const_add::controlled_sub_const(circ, flag, a, p_bytes);
    {
        ...
        circ.contract_pop_and_check::<crate::point_add::trailmix_port::num_bigint::BigUint, _>(
            ...
            move |a_pre, view, shot| -> Result<(), String> {
                ...
                let expected = (a_pre
                    * crate::point_add::trailmix_port::num_bigint::BigUint::from(2u32))
                    % &p_val;
                if a_post != expected {
                    return Err(format!(
...
pub fn controlled_mod_add_canonical_mbu(
    ...
    crate::point_add::trailmix_port::arith::ripple_add::controlled_add(circ, ctrl, acc, addend);

    let reduced = circ.alloc_qreg("cma_canonical.reduced");
    crate::point_add::trailmix_port::arith::compare::compare_geq_p_secp256k1(circ, acc, &reduced);
...
pub fn controlled_mod_sub_canonical_mbu(
    ...
    crate::point_add::trailmix_port::arith::ripple_add::controlled_sub(circ, ctrl, acc, addend);
