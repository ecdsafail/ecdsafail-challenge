...
impl ContractSimView<'_> {
    ...
    pub fn read_u256_shot(&self, reg: &[QReg], shot: usize) -> crate::point_add::trailmix_port::compat::num_bigint::BigUint {
    ...
    pub fn contract_read_u256_shot(&self, reg: &[QReg], shot: usize) -> crate::point_add::trailmix_port::compat::num_bigint::BigUint {
...
pub trait ContractReadable {
    fn contract_read_u256_shot(&self, reg: &[QReg], shot: usize) -> crate::point_add::trailmix_port::compat::num_bigint::BigUint;
