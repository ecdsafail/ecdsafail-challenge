...
impl Debugger {
    ...
    pub fn attach(circ: &mut crate::point_add::trailmix_port::circuit::Circuit) -> Self {
        ...
        // RSS so OOMs are debuggable. Cheap (~10 field reads); no env gate.
        {
            ...
            let rss_mib = crate::point_add::trailmix_port::circuit::Circuit::current_rss_kib()
                .unwrap_or(0)
                / 1024;
            eprintln!(
    ...
    fn build_whole_profile_cache(
        circ: &crate::point_add::trailmix_port::circuit::Circuit,
    ) -> ProfileCache {
    ...
    #[must_use]
    pub fn pending_ghosts_at_cursor(
        &self,
    ) -> Vec<&crate::point_add::trailmix_port::circuit::GhostEvent> {
        let gc = self.cursor();
    ...
    pub fn read_tagged_reg(
        ...
        let mut val = crate::point_add::trailmix_port::compat::num_bigint::BigUint::from(0u32);
        for k in 0..max_bits {
            ...
            if (self.qubit(qid) >> shot) & 1 == 1 {
                val |=
                    crate::point_add::trailmix_port::compat::num_bigint::BigUint::from(1u32) << k;
            }
        }
        val
    }
