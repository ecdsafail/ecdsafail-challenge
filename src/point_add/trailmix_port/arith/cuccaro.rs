...
fn add_cuccaro_post_check(circ: &mut Circuit, a: &[QReg], b: &[QReg]) {
    ...
    circ.contract_pop_and_check::<(crate::point_add::trailmix_port::compat::num_bigint::BigUint, crate::point_add::trailmix_port::compat::num_bigint::BigUint), _>(
        ...
        move |cap, view, shot| -> Result<(), String> {
            ...
            let modulus = crate::point_add::trailmix_port::compat::num_bigint::BigUint::from(1u32) << n;
...
pub fn controlled_add_cuccaro_3n_refs(circ: &mut Circuit, ctrl: &QReg, a: &[&QReg], b: &[&QReg]) {
    ...
    if n > 0 {
        ...
        circ.contract_capture(
            ...
            move |view, shot| -> Result<(crate::point_add::trailmix_port::compat::num_bigint::BigUint, crate::point_add::trailmix_port::compat::num_bigint::BigUint, bool), String> {
                let read = |regs: &[&QReg]| -> crate::point_add::trailmix_port::compat::num_bigint::BigUint {
                    let mut v = crate::point_add::trailmix_port::compat::num_bigint::BigUint::from(0u32);
                    for (i, q) in regs.iter().enumerate() {
                        if view.contract_read_bit_shot(q, shot) {
...
fn controlled_add_cuccaro_3n_post_check_refs(
    ...
    circ.contract_pop_and_check::<(crate::point_add::trailmix_port::compat::num_bigint::BigUint, crate::point_add::trailmix_port::compat::num_bigint::BigUint, bool), _>(
        ...
        move |cap, view, shot| -> Result<(), String> {
            ...
            let modulus = crate::point_add::trailmix_port::compat::num_bigint::BigUint::from(1u32) << n;
            let addend = if *c_pre { b_pre.clone() } else { crate::point_add::trailmix_port::compat::num_bigint::BigUint::from(0u32) };
