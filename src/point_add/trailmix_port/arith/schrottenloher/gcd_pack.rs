...
pub fn forward_gcd_pack_quantum_secp256k1_m(
    ...
    let q_bigint: crate::point_add::trailmix_port::compat::num_bigint::BigUint = (crate::point_add::trailmix_port::compat::num_bigint::BigUint::from(1u32) << n as u32)
        - crate::point_add::trailmix_port::compat::num_bigint::BigUint::from(super::F_SECP256K1);
