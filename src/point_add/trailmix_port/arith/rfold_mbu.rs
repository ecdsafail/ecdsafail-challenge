...
pub fn mod_add_rfold_mbu(circ: &mut Circuit, a: &[QReg], b: &[QReg]) {
    ...
    let p = crate::point_add::trailmix_port::compat::num_bigint::BigUint::from_bytes_le(
...
fn controlled_add_with_carry_to_high(circ: &mut Circuit, ctrl: &QReg, a: &[QReg], b: &[QReg]) {
    ...
    if !aliases {
        crate::point_add::trailmix_port::arith::cuccaro::controlled_add_cuccaro_with_overflow(
            circ,
            ctrl,
            &a[..=n],
            b,
