...
fn configure_sub1000_trailmix_route() {
    ...
    // Keep the trusted Q968 quotient widths. The allocation-free hybrid-CLZ
    // transcript adder below removes the remaining peak carry qubit instead of
    // narrowing the quotient support.
    ...
    set_default_env("TRAILMIX_TAIL_NONCE", "103324");
}
