...
fn configure_sub1000_trailmix_route() {
    ...
    // Trusted-clean q973 route: add the compact Khattar-Gidney prefix ancilla
    // layout to the q974 target-684 CLZ fold route. GPU TrailMix-thin prefilter
    // plus full local validation found nonce 1071 with zero classical, phase,
    // or ancilla failures.
    ...
    set_default_env("TRAILMIX_TAIL_NONCE", "1071");
}
