...
pub fn build_builder() -> crate::point_add::B {
    ...
    let ops_capacity = if inversion::paper2607_eea::enabled() {
        // Exact count-only composition: 24,450,531 surrounding PA operations
        // plus 645,769,484 operations from four certified EEA traversals.
        // Reserve once so the submission build never doubles this giant Vec.
        670_220_015
    } else {
        751_661_003
    };
