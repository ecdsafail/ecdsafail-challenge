...
fn configure_sub1000_trailmix_route() {
    ...
    // The q977 route lowers the selective target by one more lane. Nonce 251
    // passed the trusted 9,024-shot evaluator with zero classical, phase, and
    // ancilla failures. Each -1 in TARGET trims the peak step's q by one.
    ...
    set_default_env("TRAILMIX_TAIL_NONCE", "251");
}
