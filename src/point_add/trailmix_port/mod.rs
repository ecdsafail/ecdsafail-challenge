...
fn configure_sub1000_trailmix_route() {
    ...
    // Trusted Q956 route: borrow counter[0] as the active-body `off` lane.
    // The exhaustive alias proof and 9,024-shot evaluator gate are archived.
    ...
    set_default_env("TRAILMIX_TAIL_NONCE", "676055");
}
