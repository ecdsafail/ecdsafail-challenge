...
pub fn q949_route_identity() -> String {
    let mut hasher = sha3::Shake256::default();
    hasher.update(b"q949-route-identity-v10");
...
pub fn build_builder() -> crate::point_add::B {
    ...
    // Reserve the source-baked Q827 complete-cover stream exactly. The
    // all-dirty selector and serial split-five route emits 757,838,355 records;
    ...
    let mut circ = circuit::Circuit::new_with_ops_capacity(757_838_355);
