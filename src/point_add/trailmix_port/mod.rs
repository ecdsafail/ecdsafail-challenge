...
pub fn build_builder() -> crate::point_add::B {
    ...
    // Reserve the source-baked Q825 seven-bit quotient stream exactly. The
    // composed route emits 751,661,003 records;
    // avoiding the older 1,355,086,804-record reservation is necessary for
    // the 64 GiB submission-server envelope.
    // Vec can still grow for an explicitly overridden experimental route.
    let mut circ = circuit::Circuit::new_with_ops_capacity(751_661_003);
