...
fn configure_sub1000_trailmix_route() {
    ...
    // Pareto T-first route: retain the trusted support workspace, bank the
    // independent lower-width cuts, and enable only the four-high half of the
    // Q838 cover. The rotated support and direct ULS selector stay disabled.
    ...
    set_default_env("LOWQ_SUB800_BORROW_PROMISED_SUPPORT_LENDER", "1");
