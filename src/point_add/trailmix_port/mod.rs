...
pub fn build_builder() -> crate::point_add::B {
    ...
    // The packaged Q883 stream exceeds 2^30 operations. Exact reservation
    // avoids Vec's 2^31-entry growth cliff without changing any emitted op.
    let mut circ = circuit::Circuit::new_with_ops_capacity(894_173_407);
