...
fn configure_sub1000_trailmix_route() {
    set_default_env("LOWQ_ROUTE_VARIANT", "dirty-demux");
    set_default_env("LOWQ_DIRTY_DEMUX", "1");
    ...
    // Validated: 978 qubits, 9024/9024 OK with TARGET=686, tail nonce 176 (pua-ecdsafail).
    // (979 was TARGET=687 nonce 270; each -1 in TARGET trims the peak step's q by 1.)
    ...
    set_default_env("TRAILMIX_TAIL_NONCE", "100748232");
}
