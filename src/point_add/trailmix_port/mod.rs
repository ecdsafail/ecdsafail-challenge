...
fn configure_sub1000_trailmix_route() {
    ...
    // elimination of fixed-one/flag workspace. Nonce 100002 passed all 9024
    // challenge tests on WMICluster with zero classical, phase, or ancilla
    // failures.
    ...
    set_default_env("TRAILMIX_TAIL_NONCE", "700159890");
}
